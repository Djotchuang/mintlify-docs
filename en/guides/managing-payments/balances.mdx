...
- [Voting Contest](/en/guides/no-code-solutions/voting-contest)
- [Products and Stores](/en/guides/no-code-solutions/products)

...are recorded in your **Main Wallet Balance**.

<Info>
You can view your wallet balance directly from the **Balances** tab on the Fapshi Dashboard or Mobile App.
</Info>
...
You can view both your **Main Wallet Balance** and your **Service-specific Balances** from the Balances/Servicess tab:

- On Web: Go to **Dashboard > Balances**
- On Mobile: Tap the **Balances/Services** tab at the bottom of the app
