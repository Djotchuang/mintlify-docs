...
The body of the webhook request will be the same as the response body returned when [querying a payment status](/en/api-reference/endpoint/payment-status).
