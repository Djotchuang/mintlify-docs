...
description: 'The event ticketing field in docs.json defines the pages that go in the event ticketing menu'
icon: 'map'
---

The event ticketing menu is the list of links on every website.
